...
file = client.open('SPREADSHEET NAME HERE')    #EDIT HERE - CHANGE NAME IN PARANTHESIS WITH NAME OF SPREADSHEET
...
thirdList = valsSheet.col_values(17)
genderList = valsSheet.col_values(23)
raceList = valsSheet.col_values(24)
veteranList = valsSheet.col_values(25)
disabledList = valsSheet.col_values(26)
salaryList = valsSheet.col_values(28)
...
def formatStats():
	...
	row6 = ["LinkedIn Post", "", "", "Total Decline to Specify:", "", "", "Asian", "", "", "3rd Round", "", "", "Veteren who served on active duty during a war or campaign", "", "", "Decline to Answer"]
	...
	row15 = ["Gender", "Stages"]
	row16 = ["", "Phone Screen", "1st Round", "2nd Round", "3rd Round"]
	row17 = ["Female"]
	row18 = ["Male"]
	row19 = ["NonBinary"]
	...
	row26 = ["", "Phone Screen", "1st Round", "2nd Round", "3rd Round"]
	row27 = ["Hispanic"]
	row28 = ["White"]
	...
	row40 = ["", "Phone Screen", "", "", "", "", "1st Round", "",  "", "", "", "2nd Round",  "", "", "", "", "3rd Round"]
...
def stagesStats():
	...
	statsSheet.update_acell('K6', tcount)
...
def gender_stagesStats():
	...
	for index in range(len(genderList)):
		if index > 0:
			...
			if "Female" in genderList[index] and thirdList[index] == "TRUE":
				f3c += 1
			if "Male" in genderList[index] and thirdList[index] == "TRUE":
				m3c += 1
			if "NonBinary" in genderList[index] and thirdList[index] == "TRUE":
				n3c += 1
			if "Decline to Specify" in genderList[index] and thirdList[index] == "TRUE":
				d3c += 1
			if "No Data" in genderList[index] and thirdList[index] == "TRUE":
				nd3c += 1	
	...
	statsSheet.update_acell('E17', f3c)
	statsSheet.update_acell('E18', m3c)
	statsSheet.update_acell('E19', n3c)
	statsSheet.update_acell('E20', d3c)
	statsSheet.update_acell('E21', nd3c)
...
def ethnicity_stagesStats():
	...
	for index in range(len(raceList)):
		if index > 0:
			...
			if "Hispanic" in raceList[index] and thirdList[index] == "TRUE":
				h3c+= 1
			if "White" in raceList[index] and thirdList[index] == "TRUE":
				w3c+= 1
			if "American Indian" in raceList[index] and thirdList[index] == "TRUE":
				ai3c += 1
			if "Asian" in raceList[index] and thirdList[index] == "TRUE":
				a3c += 1
			if "Black" in raceList[index] and thirdList[index] == "TRUE":
				b3c += 1
			if "Decline" in raceList[index] and thirdList[index] == "TRUE":
				d3c += 1
			if "Two" in raceList[index] and thirdList[index] == "TRUE":
				two3c += 1
			if "Native Native" in raceList[index] and thirdList[index] == "TRUE":
				n3c += 1
			if "No Data" in raceList[index] and thirdList[index] == "TRUE":
				nd3c += 1
	...
	statsSheet.update_acell('E27', h3c)
	statsSheet.update_acell('E28', w3c)
	statsSheet.update_acell('E29', ai3c)
	statsSheet.update_acell('E30', a3c)
	statsSheet.update_acell('E31', b3c)
	statsSheet.update_acell('E32', d3c)
	statsSheet.update_acell('E33', two3c)
	statsSheet.update_acell('E34', n3c)
	statsSheet.update_acell('E35', nd3c)
...
def stages_ethnicity_genderStats():
	...
	for index in range(len(raceList)):
		if index > 0:
			...
			if "Hispanic" in raceList[index] and thirdList[index] == "TRUE" and "Female" in genderList[index]:
				hf3count += 1
			if "Hispanic" in raceList[index] and thirdList[index] == "TRUE" and "Male" in genderList[index]:
				hm3count += 1
			if "Hispanic" in raceList[index] and thirdList[index] == "TRUE" and "NonBinary" in genderList[index]:
				hn3count += 1
			if "Hispanic" in raceList[index] and thirdList[index] == "TRUE" and "Decline to Specify" in genderList[index]:
				hd3count += 1
			if "Hispanic" in raceList[index] and thirdList[index] == "TRUE" and "No Data" in genderList[index]:
				hnd3count += 1
			...
			if "White" in raceList[index] and thirdList[index] == "TRUE" and "Female" in genderList[index]:
				wf3count += 1
			if "White" in raceList[index] and thirdList[index] == "TRUE" and "Male" in genderList[index]:
				wm3count += 1
			if "White" in raceList[index] and thirdList[index] == "TRUE" and "NonBinary" in genderList[index]:
				wn3count += 1
			if "White" in raceList[index] and thirdList[index] == "TRUE" and "Decline to Specify" in genderList[index]:
				wd3count += 1
			if "White" in raceList[index] and thirdList[index] == "TRUE" and "No Data" in genderList[index]:
				wnd3count += 1
			...
			if "American Indian" in raceList[index] and thirdList[index] == "TRUE" and "Female" in genderList[index]:
				aif3count += 1
			if "American Indian" in raceList[index] and thirdList[index] == "TRUE" and "Male" in genderList[index]:
				aim3count += 1
			if "American Indian" in raceList[index] and thirdList[index] == "TRUE" and "NonBinary" in genderList[index]:
				ain3count += 1
			if "American Indian" in raceList[index] and thirdList[index] == "TRUE" and "Decline to Specify" in genderList[index]:
				aid3count += 1
			if "American Indian" in raceList[index] and thirdList[index] == "TRUE" and "No Data" in genderList[index]:
				aind3count += 1
			...
			if "Asian" in raceList[index] and thirdList[index] == "TRUE" and "Female" in genderList[index]:
				af3count += 1
			if "Asian" in raceList[index] and thirdList[index] == "TRUE" and "Male" in genderList[index]:
				am3count += 1
			if "Asian" in raceList[index] and thirdList[index] == "TRUE" and "NonBinary" in genderList[index]:
				an3count += 1
			if "Asian" in raceList[index] and thirdList[index] == "TRUE" and "Decline to Specify" in genderList[index]:
				ad3count += 1
			if "Asian" in raceList[index] and thirdList[index] == "TRUE" and "No Data" in genderList[index]:
				and3count += 1
			...
			if "Black" in raceList[index] and thirdList[index] == "TRUE" and "Female" in genderList[index]:
				bf3count += 1
			if "Black" in raceList[index] and thirdList[index] == "TRUE" and "Male" in genderList[index]:
				bm3count += 1
			if "Black" in raceList[index] and thirdList[index] == "TRUE" and "NonBinary" in genderList[index]:
				bn3count += 1
			if "Black" in raceList[index] and thirdList[index] == "TRUE" and "Decline to Specify" in genderList[index]:
				bd3count += 1
			if "Black" in raceList[index] and thirdList[index] == "TRUE" and "No Data" in genderList[index]:
				bnd3count += 1
			...
			if "Decline" in raceList[index] and thirdList[index] == "TRUE" and "Female" in genderList[index]:
				df3count += 1
			if "Decline" in raceList[index] and thirdList[index] == "TRUE" and "Male" in genderList[index]:
				dm3count += 1
			if "Decline" in raceList[index] and thirdList[index] == "TRUE" and "NonBinary" in genderList[index]:
				dn3count += 1
			if "Decline" in raceList[index] and thirdList[index] == "TRUE" and "Decline to Specify" in genderList[index]:
				dd2count += 1
			if "Decline" in raceList[index] and thirdList[index] == "TRUE" and "No Data" in genderList[index]:
				dnd3count += 1
			...
			if "Two" in raceList[index] and thirdList[index] == "TRUE" and "Female" in genderList[index]:
				twof3count += 1
			if "Two" in raceList[index] and thirdList[index] == "TRUE" and "Male" in genderList[index]:
				twom3count += 1
			if "Two" in raceList[index] and thirdList[index] == "TRUE" and "NonBinary" in genderList[index]:
				twon3count += 1
			if "Two" in raceList[index] and thirdList[index] == "TRUE" and "Decline to Specify" in genderList[index]:
				twod3count += 1
			if "Two" in raceList[index] and thirdList[index] == "TRUE" and "No Data" in genderList[index]:
				twond3count += 1
			...
			if "Native Hawaiian" in raceList[index] and thirdList[index] == "TRUE" and "Female" in genderList[index]:
				nf3count += 1
			if "Native Hawaiian" in raceList[index] and thirdList[index] == "TRUE" and "Male" in genderList[index]:
				nm3count += 1
			if "Native Hawaiian" in raceList[index] and thirdList[index] == "TRUE" and "NonBinary" in genderList[index]:
				nn3count += 1
			if "Native Hawaiian" in raceList[index] and thirdList[index] == "TRUE" and "Decline to Specify" in genderList[index]:
				nd3count += 1
			if "Native Hawaiian" in raceList[index] and thirdList[index] == "TRUE" and "No Data" in genderList[index]:
				nnd3count += 1
			...
			if "No Data" in raceList[index] and thirdList[index] == "TRUE" and "Female" in genderList[index]:
				ndf3count += 1
			if "No Data" in raceList[index] and thirdList[index] == "TRUE" and "Male" in genderList[index]:
				ndm3count += 1
			if "No Data" in raceList[index] and thirdList[index] == "TRUE" and "NonBinary" in genderList[index]:
				ndn3count += 1
			if "No Data" in raceList[index] and thirdList[index] == "TRUE" and "Decline to Specify" in genderList[index]:
				ndd3count += 1
			if "No Data" in raceList[index] and thirdList[index] == "TRUE" and "No Data" in genderList[index]:
				ndnd3count += 1
	...
	statsSheet.update_acell('Q42', hf3count)
	statsSheet.update_acell('Q43', wf3count)
	statsSheet.update_acell('Q44', aif3count)
	statsSheet.update_acell('Q45', af3count)
	statsSheet.update_acell('Q46', bf3count)
	statsSheet.update_acell('Q47', df3count)
	statsSheet.update_acell('Q48', twof3count)
	statsSheet.update_acell('Q49', nf3count)
	statsSheet.update_acell('Q50', ndf3count)

	statsSheet.update_acell('R42', hm3count)
	statsSheet.update_acell('R43', wm3count)
	statsSheet.update_acell('R44', aim3count)
	statsSheet.update_acell('R45', am3count)
	statsSheet.update_acell('R46', bm3count)
	statsSheet.update_acell('R47', dm3count)
	statsSheet.update_acell('R48', twom3count)
	statsSheet.update_acell('R49', nm3count)
	statsSheet.update_acell('R50', ndm3count)

	statsSheet.update_acell('S42', hn3count)
	statsSheet.update_acell('S43', wn3count)
	statsSheet.update_acell('S44', ain3count)
	statsSheet.update_acell('S45', an3count)
	statsSheet.update_acell('S46', bn3count)
	statsSheet.update_acell('S47', dn3count)
	statsSheet.update_acell('S48', twon3count)
	statsSheet.update_acell('S49', nn3count)
	statsSheet.update_acell('S50', ndn3count)

	statsSheet.update_acell('T42', hd3count)
	statsSheet.update_acell('T43', wd3count)
	statsSheet.update_acell('T44', aid3count)
	statsSheet.update_acell('T45', ad3count)
	statsSheet.update_acell('T46', bd3count)
	statsSheet.update_acell('T47', dd3count)
	statsSheet.update_acell('T48', twod3count)
	statsSheet.update_acell('T49', nd3count)
	statsSheet.update_acell('T50', ndd3count)

	statsSheet.update_acell('U42', hnd3count)
	statsSheet.update_acell('U43', wnd3count)
	statsSheet.update_acell('U44', aind3count)
	statsSheet.update_acell('U45', and3count)
	statsSheet.update_acell('U46', bnd3count)
	statsSheet.update_acell('U47', dnd3count)
	statsSheet.update_acell('U48', twond3count)
	statsSheet.update_acell('U49', nnd3count)
	statsSheet.update_acell('U50', ndnd3count)
